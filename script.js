...
class todoList{
    constructor(place, title = "to-do list"){
        ...
        this.button.innerText = 'Ajouter une tâche';
...
class Card{
    constructor(text, place, todoList){
        ...
        this.state = {
            text: text,
            description: "Ecrire une description ou un commentaire",
            comments: []
        }
        this.render();
    }
    ...
    showMenu(){//todoList1.cardArray[0].showMenu()
        ...
        this.commentsButton.innerText = "Ajouter";
        this.commentsInput.placeholder = "Ecrire un commentaire";
